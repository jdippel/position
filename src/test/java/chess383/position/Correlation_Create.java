...
/**
 * <p>
 * The class Correlation_Create implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 ...
 *
 */
@DisplayName("the public static method Correlation create( ) for class Correlation is tested")
public class Correlation_Create {  
